...
(function() {
   ...
   * @param {Json} MonitoringPointsOptions 可选的输入参数，非必填项。可输入选项包括：<br />
  ...
  BMapLib.MonitoringPoints = function (params, dashed) {
    ...
    this._opts = baidu.extend(
      baidu.extend(this._opts || {}, {
         ...
         * @type {BMap.Size}
         */
        anchor: new BMap.Size(-20, -52)
      }), opts);
  }

  // 继承覆盖物类
  MonitoringPoints.prototype = new BMap.Overlay();
   ...
   */
  MonitoringPoints.prototype.initialize = function (map) {
    var me = this,
   ...
   * @private
   */
  MonitoringPoints.prototype.draw = function () {
      var map = this._map,
   ...
   *
   * @example <b>参考示例：</b>
   * myMonitoringPointsObject.getAnchor();
   */
  MonitoringPoints.prototype.getAnchor = function () {
   ...
   *
   * @example <b>参考示例：</b>
   * myMonitoringPointsObject.setAnchor(new BMap.Size(-72, -84));
   */
  MonitoringPoints.prototype.setAnchor = function (anchor) {
   ...
   * @return 无返回值
   */
  MonitoringPoints.prototype._appendContent = function () {
   ...
   * @return 无返回值
   */
  MonitoringPoints.prototype._setEventDispath = function () {
    var me = this,
        div = me._container,
        isMouseDown = false,
    ...
    baidu.on(div, "onclick", function (e) {
        $(div).find('a').addClass('selected');
        /**
         * 点击Marker时，派发事件的接口
         * @name MonitoringPoints#onclick
         * @event
         ...
         *
         * @example <b>参考示例：</b>
         * myMonitoringPointsObject.addEventListener("onclick", function(e) {
         *     alert(e.type);
         * });
         */
    ...
    baidu.on(div, "onmouseover", function(e){
       ...
       * @name MonitoringPoints#onmouseover
       * @event
       * @param {Event Object} e 回调函数会返回event参数，包括以下返回值：
       * <br />{"<b>target</b> : {BMap.Overlay} 触发事件的元素,
       * <br />"<b>type</b>：{String} 事件类型,
       ...
       *
       * @example <b>参考示例：</b>
       * myMonitoringPointsObject.addEventListener("onmouseover", function(e) {
       *     alert(e.type);
       * });
       */
    ...
    baidu.on(div, "onmouseout", function(e){
       ...
       *
       * @example <b>参考示例：</b>
       * myMonitoringPointsObject.addEventListener("onmouseout", function(e) {
       *     alert(e.type);
       * });
       */
   ...
   * @return 无返回值
   */
  MonitoringPoints.prototype.remove = function () {
